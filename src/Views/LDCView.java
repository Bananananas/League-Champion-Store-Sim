...
public class LDCView extends JFrame implements ActionListener {	
	...
	public LDCView() {
		...
		jplChampButtons.add(jbtAhri);
		jplChampButtons.add(jbtAkali);
		jplChampButtons.add(jbtAlistar);
		jplChampButtons.add(jbtAmumu);
		jplChampButtons.add(jbtAnivia);
		jplChampButtons.add(jbtAnnie);
		jplChampButtons.add(jbtAshe);
		jplChampButtons.add(jbtBlitzcrank);
		jplChampButtons.add(jbtBrand);
		jplChampButtons.add(jbtCaitlyn);
		jplChampButtons.add(jbtCassiopeia);
		jplChampButtons.add(jbtChogath);
		jplChampButtons.add(jbtCorki);
		jplChampButtons.add(jbtDarius);
		jplChampButtons.add(jbtDiana);
		jplChampButtons.add(jbtDrmundo);
		jplChampButtons.add(jbtDraven);
		jplChampButtons.add(jbtElise);
		jplChampButtons.add(jbtEvelynn);
		jplChampButtons.add(jbtEzreal);
		jplChampButtons.add(jbtFiddlesticks);
		jplChampButtons.add(jbtFiora);
		jplChampButtons.add(jbtFizz);
		jplChampButtons.add(jbtGalio);
		jplChampButtons.add(jbtGangplank);
		jplChampButtons.add(jbtGaren);
		jplChampButtons.add(jbtGragas);
		jplChampButtons.add(jbtGraves);
		jplChampButtons.add(jbtHecarim);
		jplChampButtons.add(jbtHeimerdinger);
		jplChampButtons.add(jbtIrelia);
		jplChampButtons.add(jbtJanna);
		jplChampButtons.add(jbtJarvenIV);
		jplChampButtons.add(jbtJax);
		jplChampButtons.add(jbtJayce);
		jplChampButtons.add(jbtKarma);
		jplChampButtons.add(jbtKarthus);
		jplChampButtons.add(jbtKassadin);
		jplChampButtons.add(jbtKatarina);
		jplChampButtons.add(jbtKayle);
		jplChampButtons.add(jbtKennen);
		jplChampButtons.add(jbtKhazix);
		jplChampButtons.add(jbtKogmaw);
		jplChampButtons.add(jbtLeblanc);
		jplChampButtons.add(jbtLeesin);
		jplChampButtons.add(jbtLeona);
		jplChampButtons.add(jbtLulu);
		jplChampButtons.add(jbtLux);
		jplChampButtons.add(jbtMalphite);
		jplChampButtons.add(jbtMalzahar);
		jplChampButtons.add(jbtMaokai);
		jplChampButtons.add(jbtMasteryi);
		jplChampButtons.add(jbtMissfortune);
		jplChampButtons.add(jbtMordekaiser);
		jplChampButtons.add(jbtMorgana);
		jplChampButtons.add(jbtNami);
		jplChampButtons.add(jbtNasus);
		jplChampButtons.add(jbtNautilus);
		jplChampButtons.add(jbtNidalee);
		jplChampButtons.add(jbtNocturne);
		jplChampButtons.add(jbtNunu);
		jplChampButtons.add(jbtOlaf);
		jplChampButtons.add(jbtOrianna);
		jplChampButtons.add(jbtPantheon);
		jplChampButtons.add(jbtPoppy);
		jplChampButtons.add(jbtRammus);
		jplChampButtons.add(jbtRenekton);
		jplChampButtons.add(jbtRengar);
		jplChampButtons.add(jbtRiven);
		jplChampButtons.add(jbtRumble);
		jplChampButtons.add(jbtRyze);
		jplChampButtons.add(jbtSejuani);
		jplChampButtons.add(jbtShaco);
		jplChampButtons.add(jbtShen);
		jplChampButtons.add(jbtShyvana);
		jplChampButtons.add(jbtSinged);
		jplChampButtons.add(jbtSion);
		jplChampButtons.add(jbtSivir);
		jplChampButtons.add(jbtSkarner);
		jplChampButtons.add(jbtSona);
		jplChampButtons.add(jbtSoraka);
		jplChampButtons.add(jbtSwain);
		jplChampButtons.add(jbtSyndra);
		jplChampButtons.add(jbtTalon);
		jplChampButtons.add(jbtTaric);
		jplChampButtons.add(jbtTeemo);
		jplChampButtons.add(jbtThresh);
		jplChampButtons.add(jbtTristana);
		jplChampButtons.add(jbtTrundle);
		jplChampButtons.add(jbtTryndamere);
		jplChampButtons.add(jbtTwistedfate);
		jplChampButtons.add(jbtTwitch);
		jplChampButtons.add(jbtUdyr);
		jplChampButtons.add(jbtUrgot);
		jplChampButtons.add(jbtVarus);
		jplChampButtons.add(jbtVayne);
		jplChampButtons.add(jbtVeigar);
		jplChampButtons.add(jbtVi);
		jplChampButtons.add(jbtViktor);
		jplChampButtons.add(jbtVladimir);
		jplChampButtons.add(jbtVolibear);
		jplChampButtons.add(jbtWarwick);
		jplChampButtons.add(jbtWukong);
		jplChampButtons.add(jbtXerath);
		jplChampButtons.add(jbtXinzhao);
		jplChampButtons.add(jbtYorick);
		jplChampButtons.add(jbtZed);
		jplChampButtons.add(jbtZiggs);
		jplChampButtons.add(jbtZilean);
		jplChampButtons.add(jbtZyra);		
